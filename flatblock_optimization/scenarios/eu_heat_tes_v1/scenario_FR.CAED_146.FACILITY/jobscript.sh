...
python run_scenario.py \
    --site-id FR.CAED/146.FACILITY \
    --iso3-country FRA \
    --scenario-dir scenarios/eu_heat_tes_v1/scenario_FR.CAED_146.FACILITY \
    --availability 0.9 \
    --solar-start 2023 \
    --solar-end 2023 \
    --project-start 2025 \
    ...
    --base-load-mw 5.5308 \
    --results-folder scenarios/eu_heat_tes_v1/scenario_FR.CAED_146.FACILITY/results
