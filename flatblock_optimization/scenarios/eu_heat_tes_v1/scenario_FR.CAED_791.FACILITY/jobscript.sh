...
python run_scenario.py \
    --site-id FR.CAED/791.FACILITY \
    --iso3-country FRA \
    --scenario-dir scenarios/eu_heat_tes_v1/scenario_FR.CAED_791.FACILITY \
    --availability 0.9 \
    --solar-start 2023 \
    --solar-end 2023 \
    --project-start 2025 \
    ...
    --base-load-mw 10.136 \
    --results-folder scenarios/eu_heat_tes_v1/scenario_FR.CAED_791.FACILITY/results
